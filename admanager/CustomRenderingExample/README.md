Google Ad Manager Custom Rendering Sample
===================================

This sample demonstrates how to request and display an ad from Ad Manager Custom Rendering in an Android application. The app displays an ad
at the top of its activity, and offers a few checkboxes and a button you can use
to request different native ad formats.
