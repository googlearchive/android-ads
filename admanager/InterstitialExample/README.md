Google Ad Manager Interstitial Sample
===============================

This sample demonstrates how to request and display an Ad Manager interstitial ad in an Android application. The code illustrates how
