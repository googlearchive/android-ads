Google Ad Manager Rewarded Video Sample
===================================

This sample demonstrates how to request and display a rewarded video ad from Ad Manager in an Android application. It uses a countdown timer to simulate
