DoubleClick Native Sample
=========================

This sample demonstrates how to request and display a DoubleClick for
Publishers native ad in an Android application. The app displays an ad at the
top of its activity, and offers a few checkboxes and a button you can use to
request different native ad formats.
